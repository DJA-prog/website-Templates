        ...
        while (false !== ($entry = readdir($handle))) {
            if ($entry != "." && $entry != "..") {
              ...
              if ($ext == 'jpg'||$ext == 'png'||$ext == 'jpeg') {
                ...
                echo '<div style="display:flex;">File: <a href="./Videos/'.$entry.'">'.$without_extensiony.' </a><form action="../../index/unlink.php" method="post"><input type="hidden" name="dirfile" value="Videos/'.$entry.'"><button type="submit" name="delete-submit">Delete</button></form></div><br>';
              }
        ...
        while (false !== ($entry = readdir($handle))) {
            if ($entry != "." && $entry != "..") {
              ...
              if ($ext == 'jpg'||$ext == 'png'||$ext == 'jpeg') {
                ...
                echo '<div style="display:flex;">Video: <a href="./Documents/'.$entry.'">'.$without_extensiony.' </a><form action="../../index/unlink.php" method="post"><input type="hidden" name="dirfile" value="Documents/'.$entry.'"><button type="submit" name="delete-submit">Delete</button></form></div><br>';
              }else {
